...
** Important: this project was generated by open code and glm5.1, but that doesn't mean the author didn't touch the concepts or planned the architecture. The generative coding process was long, and used my own ideas, it went through many steps and trials (just check the commits)**
